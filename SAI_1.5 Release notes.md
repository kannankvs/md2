# Switch Abstraction Interface Release Notes
### Version 1.5
...
This document describes the new features, restrictions, and fixed and known issues in SAI, Release 1.5 and later.
This release note document is applicable to all switches present in the [Supported hardware](https://github.com/Azure/SONiC/wiki/Supported-Devices-and-Platforms) section.

## Supported hardware
List of [supported platforms](https://github.com/Azure/SONiC/wiki/Supported-Devices-and-Platforms)
...
1. Express top-level Telemetry and Monitoring domain >>> JOSEPH
...
21) [PR981](https://github.com/opencomputeproject/SAI/pull/981): SAITEST: Bugfix: rif_id1 is created using lag_id1, modified to remove rif_id1 before removing lag_id1.  
22) [PR982](https://github.com/opencomputeproject/SAI/pull/982): SAITEST: Default value of ACL entry fields is 'false'. Modified to enable ACL entry action and field when creating ACL entry in PTF client.  
